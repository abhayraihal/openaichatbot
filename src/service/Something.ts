...
export class Something {
    ...
    static async sendMessage(messages: ChatMessage[], modelId: string): Promise<ChatCompletion> {
      ...
      const mappedMessages = await Something.mapChatMessagesToCompletionMessages(modelId,messages);
    ...
    //   }
      ...
      const mappedMessages = await Something.mapChatMessagesToCompletionMessages(requestBody.model,messages);

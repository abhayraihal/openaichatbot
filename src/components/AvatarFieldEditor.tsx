...
//         const isSvg = file.type.startsWith('image/svg+xml');

//         if (isPdf) {
//           // Handle PDF upload (assuming integration with your PDF generation library)
//           // Replace with your specific PDF processing logic (e.g., send to a server-side endpoint)
//           console.log('PDF uploaded:', result);
//           // You can optionally display a success message or trigger an action here

//           // Display a placeholder image for uploaded PDFs
//           setImageSrc({ data: 'placeholder-for-pdf-preview.png', type: 'pdf' });
//         } else if (isSvg) {
//           setImageSrc({ data: result, type: 'svg' });
//           if (onImageChange) {
//             onImageChange({ data: result, type: 'svg' });
//           }
//         } else {
//           // Handle non-PDF and non-SVG files (optional: display an error message)
//           console.warn('Invalid file type. Please upload an SVG or PDF.');
//         }
//       };
...
//           ) : ( // Display a placeholder image for uploaded PDFs
//             <img
//               src={imageSrc.data} // Replace with the path to your placeholder image
//               alt="Uploaded PDF"
...
//               stroke="currentColor"
//               viewBox="0 0 24 24"
//               style={{ width: `${size * 0.29}px`, height: `${size * 0.29}px` }}
//               xmlns="http://www.w3.org/2000/svg"
//             >
//               <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
//             </svg>
...
//             id="icon"
//             type="file"
//             accept="application/pdf" // Accept both SVG and PDF files
//             onChange={handleImageUpload}
//             style={{
//               position: 'absolute',
//               opacity: 0,

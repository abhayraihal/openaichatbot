...
const MessageBox = forwardRef<MessageBoxHandles, MessageBoxProps>(
  ({ loading, setLoading, callApp, allowImageAttachment }, ref) => {
    ...
    const handleAttachment = async (
      ...
      // Accept image, text, and PDF mime types
      const acceptedMimeTypes = (
        allowImageAttachment !== "no" ? IMAGE_MIME_TYPES : []
      )
        .concat(TEXT_MIME_TYPES, "application/pdf")
        .join(",");
        ...
        if (files) {
          Array.from(files).forEach(async (file) => {
            ...
            if (file.type.startsWith("image/")) {
              // Existing logic for handling image attachments (not shown here)
              ...
              try {
                ...
                if (response.ok) {
                  ...
                  // Here you can add additional logic for displaying a toast notification or updating UI
                } else {
    ...
    return (
      <div className="absolute bottom-0 left-0 w-full border-t md:border-t-0 dark:border-white/20 md:border-transparent md:dark:border-transparent bg-white dark:bg-gray-900 md:!bg-transparent pt-2">
        <form
          ...
          >
            ...
            <div className="flex items-center w-full relative">
              ...
              <div className="flex items-center justify-start">
                <button onClick={(e) => handleAttachment(e)} className="p-1">
